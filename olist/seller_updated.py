...
class Seller:
    ...
    def get_review_score(self):
        ...
        res['n_reviews'] = df.groupby('seller_id')['order_id'].count().values
        ...
        res['cost_of_reviews'] = (
            res['share_of_one_stars'] * cost_one_star +
            res['share_of_five_stars'] * cost_five_star
        ) * res['n_reviews']
    ...
    def get_training_data(self):
        ...
        # params (isteğe göre dışarı alınabilir)
        subscription_fee = 80
        sales_fee_pct = 0.10

        # subscription: ay * fee
        training_set['subscription_revenue'] = (
            training_set['months_on_olist'] * subscription_fee
        )

        # sales fee
        training_set['sales_revenue'] = (
            training_set['sales'] * sales_fee_pct
        )
